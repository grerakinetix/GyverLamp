...
#define UP_BTN_PIN            (12U)                         // пин кнопки вверх
#define DOWN_BTN_PIN          (13U)                         // пин кнопки вниз
#define LEFT_BTN_PIN          (15U)                         // пин кнопки влево
#define RIGHT_BTN_PIN         (14U)                         // пин кнопки вправо
...
// --- КНОПКИ --------------------------
#define BUTTONS_COUNT         (5U)                          // количество кнопок: 
                                                            // 1 - стандартная конфигурация (как на видео)
                                                            // 3 - центральная включает/выключает лампу и переключает эффекты, верхняя повышает яркось, нижняя понижает яркость
                                                            // 5 - центральная включает/выключает лампу, боковые переключают эффекты и регулируют масштаб при зажатии, верхняя повышает яркось, нижняя понижает яркость
