...
// ------------- белый свет (от 2700К до 6500К) -------------
uint8_t greens[100] = 
{ 
  137, 138, 139, 141, 142, 143, 144, 145, 146, 147, 149, 150, 151, 152, 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 169, 170, 171, 172, 173, 174, 175, 176, 176, 177, 178, 179, 180, 180, 181, 182, 183, 184, 184, 185, 186, 187, 187, 188, 189, 190, 190, 191, 192, 193, 193, 194, 195, 195, 196, 197, 197, 198, 199, 199, 200, 201, 201, 202, 203, 203, 204, 205, 205, 206, 206, 207, 208, 208, 209, 209, 210, 211, 211, 212, 212, 213, 214, 214, 215, 215, 216, 216, 217
};

uint8_t blues[100] = 
{
  14, 17, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 50, 53, 55, 58, 61, 63, 65, 68, 70, 72, 75, 77, 79, 81, 83, 85, 87, 89, 91, 93, 95, 97, 99, 101, 103, 105, 106, 108, 110, 112, 113, 115, 117, 118, 120, 122, 123, 125, 126, 128, 129, 131, 132, 134, 135, 137, 138, 139, 141, 142, 144, 145, 146, 148, 149, 150, 151, 153, 154, 155, 157, 158, 159, 160, 161, 163, 164, 165, 166, 167, 168, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186
};
...
void whiteColorRoutine()
{
  if (loadingFlag)
  {
    ...
    for (int16_t i = 0; i < NUM_LEDS; i++)
    {
      leds[i] = CRGB(255, greens[modes[EFF_WHITE_COLOR].Scale - 1], blues[modes[EFF_WHITE_COLOR].Scale - 1]);
    }
  }
}
